        ...
        child: isWeb? Align(
          ...
          child: Container(
            ...
            child: Padding(
              ...
              child: SizedBox.expand(
                  child: LoadingAnimationWidget.dotsTriangle(color: ColorTheme.cAppTheme.withOpacity(0.7), size: 60)),
            ),
          ),
        ):Align(
          alignment: Alignment.center,
          child: Container(
            ...
            child: Padding(
              padding: EdgeInsets.all(15.0.w),
              child: SizedBox.expand(
                  child: LoadingAnimationWidget.dotsTriangle(color: ColorTheme.cAppTheme, size: 100)),
            ),
          ),
        ),
      );
