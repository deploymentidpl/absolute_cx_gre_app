        ...
        ? SingleChildScrollView(
            ...
            child: SizedBox(
              ...
              child: Table(
                ...
                children: List.generate(leadsList.length + 1, (index) {
                  return index == 0
                      ? TableRow(
                          ...
                          children: [
                              ...
                              Padding(
                                ...
                                child: Align(
                                    ...
                                    child: Text(
                                      leadsList[index - 1].svOwnerName,
                                      style: semiBoldTextStyle(
                                        size: 14,
                                      ),
                                    )),
                              ),
                              leadsList[index - 1].leadData.isNotEmpty
                                  ? Padding(
                                      padding: const EdgeInsets.only(
                                          top: 10, bottom: 5),
                                      child: Column(
                              ...
                              Padding(
                                padding:
                                    const EdgeInsets.only(top: 10, bottom: 5),
                                child: Text(
                                  leadsList[index - 1].siteVisitStatus,
                                  style: semiBoldTextStyle(
                              ...
                              Padding(
                                  padding:
                                      const EdgeInsets.only(top: 10, bottom: 5),
                                  child: Text(
                                    leadsList[index - 1].leadSourceDescription,
                                    style: semiBoldTextStyle(
                                        size: 12, color: ColorTheme.cMosque),
                                  )),
                              Padding(
