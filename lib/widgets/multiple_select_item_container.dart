...
import '../model/CustomDropDownItemsModel/custom_dropDownItemsModel.dart';
...
class MultipleSelectedItemsContainer extends StatelessWidget
{
  ...
  const MultipleSelectedItemsContainer({super.key, required this.onTap, required this.onDelete, required this.items, required this.title, this.width=500});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Text(title,style: mediumTextStyle(size: 16, color: ColorTheme.cFontWhite)),
