...
//
//   BlockedUnitInventory(
//       {super.key,
//       required this.isMobile,
//       this.width = 500,
//       required this.showTowerDropDown,
...
//                     ),
//                   ),
//                   Positioned(bottom: 0, left: 0, child: _getBottomList())
//                 ],
//               ),
//             ),
//           )
...
//                       color: getBlockUnitColorBasedOnStatus(
...
//               child: Text(
//                 AppConstant.unitStatus[index],
//                 style: mediumTextStyle(size: 10, color: ColorTheme.cFontWhite),
//               ),
//             ),
//           ]),
//     );
...
//                             decoration:
//                                 BoxDecoration(color: ColorTheme.cAppTheme),
//                             alignment: Alignment.center,
//                             padding: const EdgeInsets.symmetric(
//                                 horizontal: 10, vertical: 6),
//                             child: Text(
//                                 _controller
//                                     .filterList.value.floors[index].floorId,
...
//                                 .filterList.value.floors[index].units
//                                 .map((e) => GestureDetector(
//                                       onTap: () {
//                                         onTap(
//                                             _controller
//                                                 .filterList.value.floors[index],
//                                             e.unitId);
//                                       },
//                                       child: Container(
//                                         height: isMobile ? 30 : 30,
