              ...
              body: ResponsiveBuilder(
                builder: (context, sizingInformation) => Row(
                  children: [
                    ...
                    //   return
                        Visibility(
                        visible: !sizingInformation.isMobile && controller.showDrawer.value,
                        child: HoverBuilder(builder: (isHovered) {
                          ...
                          return AnimatedContainer(
                            ...
                            width: 0,//(isHovered || isHoverDisable.value) ? 250 : 75,
                            child: SizedBox(
                              width: (isHovered || isHoverDisable.value) ? 250 : 75,
                              child: SizedBox(width: 0,)//sideBar(isHovered, isHoverDisable, false),
                            ),
                          );
                        }),
                      ),
              ...
              if (!ismobile)
                (isHovered || isHoverDisable.value)
                    ? InkWell(
                        ...
                        child: Icon(
                          isHoverDisable.value ? Icons.radio_button_checked_rounded : Icons.radio_button_off_rounded,
                          color: Colors.white,
                          size: 20,
                        )).paddingOnly(left: 40)
        ...
        Expanded(
          child: ListView.builder(
              ...
              itemBuilder: (ctx, index) {
                ...
                return menuListTile(obj, (isHovered || isHoverDisable.value), index);
              }),
        ),
        ListTile(
          ...
          trailing: (isHovered || isHoverDisable.value)
              ? Container(
                  decoration: BoxDecoration(color: ColorTheme.cRed, borderRadius: BorderRadius.circular(20)),
                  child: const TextWidget(text: "20", color: ColorTheme.cWhite).paddingAll(2),
                )
              : null,
          title: (isHovered || isHoverDisable.value)
              ? const TextWidget(text: "Notifications", color: ColorTheme.cWhite)
              : SvgPicture.asset(
            //todo:add string
                  "AssetsString.aBuilding",
                  colorFilter: const ColorFilter.mode(Colors.white, BlendMode.srcIn),
...
Widget menuListTile(MenuModel obj, isHovered, int index) {
  return Obx(() {
    return Container(
      decoration: (expandedIndex.value == index) ? BoxDecoration(borderRadius: BorderRadius.circular(6), color: ColorTheme.cWhite.withOpacity(0.2)) : null,
      child: Column(
        children: [
          ListTile(
            visualDensity: const VisualDensity(horizontal: -4, vertical: -4),
