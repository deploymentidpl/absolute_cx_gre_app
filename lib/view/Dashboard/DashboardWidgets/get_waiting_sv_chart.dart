...
import '../../../model/DataGridModels/sv_waiting_data_grid.dart';
                                    ...
                                    onPointTap: (pointInteractionDetails) {
                                      ...
                                      for (int i = 0;
                                        ...
                                        if (controller.svWaitlist.first
                                                    .svownerdata[i].name ==
                                                point.x &&
                                            controller.svWaitlist.first.count[i]
                                                    .toString() ==
                                                point.y.toString()) {
                                          ownerId = controller.svWaitlist.first
                                              .svownerdata[i].id;
                                        }
                                      }
                                      appLoader(context);
                                      controller
                                          .getSVWaitListClick(ownerId: ownerId)
                                          .whenComplete(
                                        () {
                            ...
                            child: Center(
                              child: SfDataGridTheme(
                                ...
                                child: SfDataGrid(
                                  ...
                                  source: SvWaitingDataGrid(
                                      dataList: controller.svWaitlist),
