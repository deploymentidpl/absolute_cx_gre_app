...
class Api {
  ...
  static const String apiAttendeeList = "$baseUrl/lead/v1/sales/svattendee/list";
  ...
  static const String apiCalenderLabel = "$baseUrl/employee/v1/event/label/list";
  ...
  static const String apiCalenderCreateEvent = "$baseUrl/employee/v1/event/create";
  static const String apiCalenderUpdateEvent = "$baseUrl/employee/v1/event/update";
  ...
  static const String apiCustomerRefUnitList = "$baseUrl/lead/v1/item360/unit/list";
  static const String apiCustomerRefSearchList = "$baseUrl/lead/v1/item360/phonenumber/list";
  static const String apiEmployeeDetailList = "$baseUrl/employee/v1/head/employee/list";
  ...
  static const String apiSVMissedList = "$baseUrl/lead/v1/past/missingorunclaimsvlist";
  static const String apiSVStart = "$baseUrl/lead/v1/sales/startsvdetails/update";
  static const String apiSVEnd = "$baseUrl/lead/v1/sales/endsvdetails/update";
  static const String apiBarrierTriggerList = "$baseUrl/lead/v1/triggerbarriers/list";
  ...
  static const String viewLeadFollowUpUrl = '$baseUrl/lead/v1/followup/retrieve';
  static const String viewLeadChangeManager = '$baseUrl/lead/v1/sales/sourcingmangerupdate';
  static const String viewLeadManagerSearchUrl = '$baseUrl/employee/v1/roleandsearchfilterlist';
  static const String viewLeadActiveEmployeeList = '$baseUrl/employee/v1/salesexecutivelist/list';
  static const String viewLeadAllEmployeeList = '$baseUrl/employee/v1/activelist';
  static const String viewLeadChangeLeadOwnerUrl = '$baseUrl/lead/v1/sent/sales/owner/change/request/generate';
  static const String viewLeadChangeOwnerUrl = '$baseUrl/lead/v1/owner/change/sticky';
  static const String viewLeadTodoPinnedUrl = '$baseUrl/leadl/v1/todo/stared/pinned';
  static const String viewLeadPreferredProject = '$baseUrl/lead/project/v1/list';
  static const String viewLeadCloneLead = '$baseUrl/lead/v1/clonelead';
  static const String viewLeadCommunicationTypeSend = '$baseUrl/lead/v1/leadactivity/communicatetype/create';
  ...
  static const String chatProjectPriceBrochureUrl = '$baseUrl/lead/v1/project/priceandbrochure/list';
  static const String chatSendCollateral = '$baseUrl/bot/v1/send/collateral';
  static const String getMediaMimetypeUrl = '$baseUrl/lead/v1/uploadmedia/mimetype';
  static const String chatSendProjectDocument = '$baseUrl/bot/v1/gupshup/whatsapp/multipledoc/send';


  static const String chatListUrl = '$baseUrl/bot/v1/contact';
  static const String chatAdvanceSearchUrl = '$baseUrl/lead/v1/search/nameornumber';
  static const String chatUpdateStatusCount = '$baseUrl/bot/v1/update/readstatusandcount';
  ...
  static const String chatSearchFilterUrl = '$baseUrl/lead/v1/dashboard/chat/lead/list';
  static const String chatBroadcastTemplateListUrl = '$baseUrl/export/v1/gupshuptemplate/list';
  static const String chatLeadUrl = '$baseUrl/bot/whatsapp/startchat/messagetemplate';


  /// analytics
  static const String chartProjectSVURL = '$baseUrl/lead/v2/sales/sitevisitchartcount';
  static const String chartOccurrenceURL = '$baseUrl/lead/v2/sales/projectandsv/graph';
  static const String chartSVPerHourURL = '$baseUrl/lead/v2/sales/svperhour';
  static const String chartSVBookingURL = '$baseUrl/lead/v2/sales/sourcewisebookingcount';
  static const String chartCPSVCountURL = '$baseUrl//lead/v1/sales/channelparnter/sitevisitecount';
