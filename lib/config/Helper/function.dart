...
DateTime getDateRangeSelection(
  ...
  switch (range) {
    ...
    case DateRangeSelection.last7Days:
      return isFromDate ? today.subtract(const Duration(days: 6)) : today;
    ...
    case DateRangeSelection.thisMonth:
      return isFromDate ? today.subtract(Duration(days: today.day - 1)) : today;
    case DateRangeSelection.last28Days:
      return isFromDate ? today.subtract(const Duration(days: 27)) : today;
    ...
    case DateRangeSelection.thisYear:
      return isFromDate ? DateTime(today.year, 1, 1) : DateTime.now();
    default:
      return DateTime.now();
  }
}
