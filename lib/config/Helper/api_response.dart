...
class ApiResponse {
  ...
  Future<Map<String, dynamic>> _header() async {
    ...
    if (apiHeaderType == ApiHeaderType.none) {
      ...
      header = {
        'Authorization': PreferenceController.getString(SharedPref.loginToken,),
            // 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..scKeSHoFnFrpFswkQHo4_g3JrkFq3f2WGUU3zbhAgM0',
